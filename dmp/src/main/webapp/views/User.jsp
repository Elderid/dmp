...
<head>
	...
	<title>E-santé , le carnet de santé electronique</title>
</head>
<body>
			...
			<div id="header-menu">
				<ul>
					...
					<li><a href="UserServlet?action=closeSessionUser"
						class="shadow-text">D�connexion</a></li>
				</ul>
			</div>
		...
		<div id="blackbar-center">
			...
			<div id="blackbar-profile">
				...
				<div id="blackbar-surname">
					<b>Pr�nom :</b> ${ userSession.surname }
				</div>
	...
	<div id="footer"></div>
	identifiant : ${userSession.identifiant}
